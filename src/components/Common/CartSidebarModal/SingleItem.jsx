...
const SingleItem = ({ item, removeItemFromCart }) => { // Was: const SingleItem = ({ item, removeItemFromCart }: { item: any, removeItemFromCart: any }) => {
  const dispatch = useDispatch(); // Was: useDispatch<AppDispatch>();

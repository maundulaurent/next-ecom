    ...
    <div>
      ...
      <section className="bg-blue-50">
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 flex justify-between py-6">
          <p className="font-semibold text-2xl text-gray-700">Checkout</p>
      ...
      {/* Checkout Section */}
      <div className="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32 py-8 shadow-lg mb-8">
          ...
          <div className="mt-8 space-y-3 rounded-lg border bg-white px-2 py-4 sm:px-6">
            <div className="flex flex-col rounded-lg bg-white sm:flex-row">
              <Image
                ...
                width={112} // 28 * 4 (w-28 in Tailwind)

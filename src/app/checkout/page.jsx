            ...
            <div className="flex flex-col lg:flex-row gap-7.5 xl:gap-11">
              ...
              <div className="lg:max-w-[670px] w-full">
                ...
                <div className="bg-white shadow-lg rounded-[10px] p-4 sm:p-8.5 mt-7.5">
                  <div>
                    <label htmlFor="notes" className="block mb-2.5 text-gray-500">
                    ...
                    <textarea
                      ...
                      className="rounded-md border border-gray-300 bg-gray-100 placeholder:text-dark-500 w-full p-5 outline-none duration-200 focus:border-transparent focus:shadow-input focus:ring-1 focus:ring-blue-800"
                    ></textarea>
                  </div>
                </div>
              </div>
              ...
              <div className="max-w-[455px] w-full">
                ...
                <button
                  type="submit"
                  className="cursor-pointer w-full flex justify-center font-medium text-white bg-blue-700 py-3 px-6 rounded-md ease-out duration-200 hover:bg-blue-900 mt-7.5"
                >
                  Process to Checkout
                </button>
              </div>
